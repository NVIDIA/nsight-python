...
- Calling :func:@nsight.analyze.kernel <nsight.analyze.kernel>-decorated functions from multiple threads is not supported, whether the threads run sequentially or concurrently.

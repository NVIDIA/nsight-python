...
- Calling :func:`@nsight.analyze.kernel <nsight.analyze.kernel>`-decorated functions from multiple threads is not supported. This includes running two decorated calls concurrently, consider the example below:
